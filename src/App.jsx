                  ...
                  <div key={log.id || lidx} className="flex items-center justify-between p-2 hover:bg-gray-50 rounded-xl transition-all group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-300">{formatDate(log.date || Object.values(log)[2])} • {calculateDuration(selectedItemForDetail.purchase_date, log.date || Object.values(log)[2])}</p>
                      </div>
                    </div>
